...
/*ques-3)	Display the total number of customers based on
...
/* ques 4)	Display all the orders along with product
...
customer.cus_name like '%A';
 ...
 /*ques9 9)	Create a stored procedure to display supplier id, name, rating and Type_of_Service.
